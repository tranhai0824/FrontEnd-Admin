...
const DropdownMenuItem = React.forwardRef<React.ElementRef<typeof DropdownMenuPrimitive.Item>, React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Item> & { inset?: boolean }>(
  ({ className, inset, ...props }, ref) => <DropdownMenuPrimitive.Item ref={ref} className={cn("relative flex cursor-default select-none items-center gap-3 rounded-sm px-3 py-2.5 text-sm outline-none transition-colors hover:bg-[#edf4ff] hover:text-[rgb(18,91,201)] focus:bg-[#edf4ff] focus:text-[rgb(18,91,201)] data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&>svg]:h-5 [&>svg]:w-5 [&>svg]:shrink-0", inset && "pl-8", className)} {...props} />,
);
